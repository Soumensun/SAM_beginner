...
with torch.no_grad():
    ...
    official_output = official_model.image_encoder.patch_embed(
        x
    )
...
with torch.no_grad():
    ...
    our_output = our_model.image_encoder.patch_embed(
        x
    )
...
difference = (official_output - our_output).abs()
...
print(official_output[0, :3, :3, :5])

print()

print("Ours")

print(our_output[0, :3, :3, :5])